...
for t = 1:niter
    ...
    [WH,pbet] = csc_arnoldi_householder(Av,Ar,Ac,r,m,LUv,0);
...
for t = 1:niter
    ...
    %Arnoldi Method with Householder
    [WH,pbet] = csc_arnoldi_householder(Av,Ar,Ac,r,m,D,1);
...
for t = 1:niter
    ...
    %Arnoldi Method with Householder
    [WH,pbet] = csc_arnoldi_householder(Av,Ar,Ac,r,m,D,2);
...
for t = 1:niter
    ...
    %Arnoldi Method with Householder
    [WH,pbet] = csc_arnoldi_householder(Av,Ar,Ac,r,m,LUv,3);
