...
%
% Additionally, it can be combined with a diagonal preconditioner by
% setting wd = 2. For standard ILU0 set wd=1. It is a multiplier of
% diagonal values
%
% Entries:
%     Av, Ar, Ac : Components of matrix A in CSC stotage
%     pc2 : second preconditioner
%        - pc2 == 0 ; no second preconditioner
%        - pc2 == 1 ; diagonal preconditioner
%        - pc2 == 2 ; absolute diagonal preconditioner
%
